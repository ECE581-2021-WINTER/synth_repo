...
set_individual_pin_constraints -sides 4 -ports [get_attribute [get_ports ] name ] -offset 400 -pin_spacing 1 -allowed_layers [ get_layers { M4 M5 M6 M7 } ]
...
create_voltage_area -power_domains PD_RISC_CORE -region { {10.0000 471.4720} {427.8480 653.6880} }
}

if { [sizeof_collection [ get_placement_blockages pb* ] ] == 0 } {
create_placement_blockage -name pb_0 -type allow_buffer_only \
    -blocked_percentage 0 -boundary { {10.0000 498.0740} {799.9440 653.6880} }
create_placement_blockage -name pb_1 -type allow_buffer_only \
    -blocked_percentage 0 -boundary { {620.6260 10.0000} {799.9440 498.0740} }
create_placement_blockage -name pb_2 -type allow_buffer_only \
    -blocked_percentage 0 -boundary { {512.6850 10.0000} {620.6260 199.2600} }
create_placement_blockage -name pb_3 -type allow_buffer_only \
    -blocked_percentage 0 -boundary { {10.0000 10.0000} {256.4200 133.8700} }
create_placement_blockage -name pb_4 -type allow_buffer_only \
    -blocked_percentage 0 -boundary { {10.0000 133.8700} {133.2100 381.6100} }
}
######PLACE
